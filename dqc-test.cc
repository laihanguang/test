...
const uint32_t TOPO_DEFAULT_QDELAY =     100;    // in ms:  300ms
...
int main(int argc, char *argv[]){
    ...
    if(instance==std::string("1")){
        ...
        linkBw=500000000;
        msDelay=10;        
    }else if(instance==std::string("15")){
        linkBw=2000000000;
        msDelay=10;        
    }else if(instance==std::string("16")){
        linkBw=10000000000;
        msDelay=10;  
    }else if(instance==std::string("17")){
        linkBw=100000;
        msDelay=100;
    }else if(instance==std::string("18")){
        linkBw=500000;
        msDelay=100;
    }else if(instance==std::string("19")){
        linkBw=3000000;
        msDelay=100;        
    }else if(instance==std::string("20")){
        linkBw=20000000;
        msDelay=100;
    }else if(instance==std::string("21")){
        linkBw=100000000;
        msDelay=100;        
    }else if(instance==std::string("22")){
        linkBw=500000000;
        msDelay=100;        
    }else if(instance==std::string("23")){
        linkBw=2000000000;
        msDelay=100;        
    }else if(instance==std::string("24")){
        linkBw=10000000000;
        msDelay=100;  
    }else if(instance==std::string("25")){
        linkBw=100000;
        msDelay=500;
    }else if(instance==std::string("26")){
        linkBw=500000;
        msDelay=500;
    }else if(instance==std::string("27")){
        linkBw=3000000;
        msDelay=500;        
    }else if(instance==std::string("28")){
        linkBw=20000000;
        msDelay=500;
    }else if(instance==std::string("29")){
        linkBw=100000000;
        msDelay=500;        
    }else if(instance==std::string("30")){
        linkBw=500000000;
        msDelay=500;        
    }else if(instance==std::string("31")){
        linkBw=2000000000;
        msDelay=500;        
    }else if(instance==std::string("32")){
        linkBw=10000000000;
        msDelay=500;  
    }
	...
	// test_pair++;
	// InstallDqc(cc,nodes.Get(0),nodes.Get(1),sendPort+1,recvPort+1,appStart+40,appStop,&trace2,max_bps,cc_id);
	// cc_id++;
	...
	// test_pair++;
	// InstallDqc(cc1,nodes.Get(0),nodes.Get(1),sendPort+2,recvPort+2,appStart+80,appStop,&trace3,max_bps,cc_id);
	// cc_id++;
